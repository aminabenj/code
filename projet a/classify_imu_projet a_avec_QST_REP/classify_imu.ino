...
void setup() {
  ...
  //*********************************** QUIZ ********************************************//
  Serial.println("\t\t\t\t ************ QUESTION_QUIZ ************ \n");
  Serial.println("Question 1: Est ce que j'ai des Enfants ?");
  Serial.println("Question 2: Est ce que j'ai déja passé le Toeic ? ");
  Serial.println("Question 3: Est ce que je m'appelle Amina ?");
  Serial.println("\n\t\t\t\t ************ REPONSE_QUIZ ************ \n");
...
void loop() {
  ...
  if (invokeStatus != kTfLiteOk) {
    ...
    {
      if((tflOutputTensor->data.f[i]>0.8)&&(j<4))
      { 
        Serial.print("Reponse ");
        Serial.print(j);
        Serial.print(": ");
        Serial.print(EMOJIS[i]);
        Serial.print("\t\t  -   Proba de la geste : ");
